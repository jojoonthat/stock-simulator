from Simulation.OrderBook import OrderBook, Order
from Simulation.utils import OrderTypes, OrderSides


# test if precendence of orders being fulfilled is correct
def test_curr_price_limit_orders():
    order = Order(0, OrderTypes.LIMIT, OrderSides.SELL, 20, 30)
    order1 = Order(1, OrderTypes.LIMIT, OrderSides.SELL, 10, 40)
    order2 = Order(2, OrderTypes.LIMIT, OrderSides.BUY, 20, 20)
    order3 = Order(3, OrderTypes.LIMIT, OrderSides.BUY, 20, 50)
...
def test_curr_price_market_orders():
    order = Order(0, OrderTypes.LIMIT, OrderSides.SELL, 20, 60)
    order1 = Order(1, OrderTypes.MARKET, OrderSides.BUY, 20)
    order2 = Order(2, OrderTypes.MARKET, OrderSides.BUY, 30)
...
def test_curr_price_all_orders():
    order = Order(0, OrderTypes.LIMIT, OrderSides.SELL, 20, 70)
    order1 = Order(1, OrderTypes.LIMIT, OrderSides.BUY, 20, 50)
    order2 = Order(2, OrderTypes.MARKET, OrderSides.BUY, 20)
...
def test_order_book_best_sell():
    order = Order(0, OrderTypes.MARKET, OrderSides.BUY, 20)
    order1 = Order(1, OrderTypes.LIMIT, OrderSides.SELL, 50, 30)
    order2 = Order(2, OrderTypes.MARKET, OrderSides.SELL, 20)
...
def test_order_book_best_buy():
    order = Order(0, OrderTypes.MARKET, OrderSides.BUY, 20)
    order1 = Order(1, OrderTypes.LIMIT, OrderSides.SELL, 50, 30)
    order2 = Order(2, OrderTypes.LIMIT, OrderSides.BUY, 20, 10)
    order_book = OrderBook("U", 100)
    order_book.add_order(order)
    order_book.add_order(order1)
    order_book.add_order(order2)
...
def test_order_book_buy_list():
    order = Order(0, OrderTypes.LIMIT, OrderSides.SELL, 20, 40)
    order1 = Order(1, OrderTypes.LIMIT, OrderSides.BUY, 20, 30)
...
def test_market_buy_sell_match_price():
    order = Order(0, OrderTypes.MARKET, OrderSides.BUY, 20)
    order1 = Order(1, OrderTypes.MARKET, OrderSides.SELL, 20)
